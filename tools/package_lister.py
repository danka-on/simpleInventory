...
def package_extension(dist: Path, output: Path) -> dict:
...
def build_feed(dist: Path, output: Path, deploy: Path) -> dict:
    result = package_extension(dist, output)
...
if __name__ == '__main__':
    ...
    result = build_feed(ROOT / 'lister-extension', destination, ROOT / 'deploy' / 'lister')
