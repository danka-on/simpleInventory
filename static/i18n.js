...
const translations = {
  ...
  no_listings: { en: 'No Listings', lt: 'Nėra skelbimų' },
  ...
  no_no_listings: { en: 'No unlisted warehouse items', lt: 'Nėra sandėlio prekių be skelbimų' },
  ...
  ebay_unread_messages_alert: { en: 'Unread eBay messages alert', lt: 'Įspėjimas: neskaitytos eBay žinutės' },
  amazon_unread_messages_alert: { en: 'Unread Amazon messages alert', lt: 'Įspėjimas: neskaitytos Amazon žinutės' },
  open_mail_center: { en: 'Open Mail Center', lt: 'Atidaryti pašto centrą' },
  ...
  prep_plus_step_name: { en: 'Name', lt: 'Pavadinimas' },
  prep_plus_name_hint: { en: 'say it or type it', lt: 'pasakykite arba įveskite' },
  prep_plus_name_placeholder: { en: 'Brand, item, size, colour', lt: 'Prekės ženklas, prekė, dydis, spalva' },
  prep_plus_say_name: { en: 'Say the name', lt: 'Pasakykite pavadinimą' },
  prep_plus_step_condition: { en: 'Condition', lt: 'Būklė' },
  prep_plus_damaged: { en: 'Damaged', lt: 'Pažeista' },
  prep_plus_what_is_wrong: { en: 'What is wrong?', lt: 'Kas negerai?' },
  prep_plus_defect_missing_pieces: { en: 'Missing pieces', lt: 'Trūksta dalių' },
  prep_plus_defect_wrong_item: { en: 'Wrong item', lt: 'Netinkama prekė' },
  prep_plus_defect_broken: { en: 'Broken', lt: 'Sulaužyta' },
  prep_plus_defect_box_damage: { en: 'Box damage', lt: 'Pažeista pakuotė' },
  prep_plus_defect_return: { en: 'Return', lt: 'Grąžinimas' },
  prep_plus_defect_replacement: { en: 'Replacement', lt: 'Pakeitimas' },
  prep_plus_defect_other: { en: 'Other', lt: 'Kita' },
  prep_plus_condition_note: { en: 'Condition note', lt: 'Būklės pastaba' },
  prep_plus_note_placeholder: { en: 'Dictate it, or type what a buyer needs to know', lt: 'Padiktuokite arba įveskite tai, ką pirkėjas turi žinoti' },
  prep_plus_say_condition: { en: 'Say the condition', lt: 'Pasakykite būklę' },
  prep_plus_drop_recording: { en: 'Drop', lt: 'Pašalinti' },
  prep_plus_step_barcode: { en: 'Barcode', lt: 'Brūkšninis kodas' },
  prep_plus_barcode_hint: { en: 'scan, type, or make one', lt: 'skenuokite, įveskite arba sukurkite' },
  prep_plus_barcode_placeholder: { en: 'Scan or type', lt: 'Skenuokite arba įveskite' },
  prep_plus_generate: { en: 'Generate', lt: 'Sukurti' },
  prep_plus_print_label: { en: 'Print label', lt: 'Spausdinti etiketę' },
  prep_plus_lookup_stores: { en: 'Look up in stores', lt: 'Ieškoti parduotuvėse' },
  prep_plus_lot_number: { en: 'Lot number', lt: 'Partijos numeris' },
  prep_plus_optional: { en: '(optional)', lt: '(nebūtina)' },
  prep_plus_lot_placeholder: { en: 'Leave empty for store finds', lt: 'Palikite tuščią parduotuvės radiniams' },
  prep_plus_next_item: { en: 'Next item →', lt: 'Kita prekė →' },
  prep_plus_ready_hint: { en: 'A name and a barcode are needed before this item can go on.', lt: 'Prieš tęsiant reikia pavadinimo ir brūkšninio kodo.' },
  prep_plus_this_session: { en: 'This session', lt: 'Ši sesija' },
  prep_plus_queue_empty_count: { en: 'Nothing added yet.', lt: 'Kol kas nieko nepridėta.' },
  prep_plus_queue_empty: { en: 'Items appear here as they upload. Keep this tab open until they all say uploaded.', lt: 'Prekės čia atsiranda joms įkeliant. Neuždarykite šio lango, kol visos nebus įkeltos.' },
  prep_plus_link_items: { en: 'Items to List →', lt: 'Paruoštos prekės →' },
  prep_plus_link_prep: { en: 'Item Prep →', lt: 'Prekių paruošimas →' },
  prep_plus_link_queue: { en: 'Print queue →', lt: 'Spausdinimo eilė →' },
  ...
  finder_tagline: { en: 'Track any item and its trail through the warehouse', lt: 'Sekite bet kurią prekę ir jos kelią sandėlyje' },
  finder_search_placeholder: { en: 'Scan a barcode for the full trail, or type a few words to find candidates', lt: 'Nuskenuokite brūkšninį kodą visam keliui arba įveskite kelis žodžius' },
  finder_hint: { en: 'A complete barcode opens the trail straight away. Words search names; use Any words when names differ. Short numbers are sizes, not codes.', lt: 'Pilnas brūkšninis kodas iškart atveria kelią. Žodžiai ieško pavadinimuose; naudokite Bet kuris žodis, kai pavadinimai skiriasi. Trumpi skaičiai yra dydžiai, ne kodai.' },
  all_words: { en: 'All words', lt: 'Visi žodžiai' },
  any_words: { en: 'Any words', lt: 'Bet kuris žodis' },
  custom_items_only: { en: 'Custom items only', lt: 'Tik pritaikytos prekės' },
  related_upcs: { en: 'Include related UPCs (-suffix units)', lt: 'Įtraukti susijusius UPC (-priesagos vienetus)' },
  ledger_memory: { en: 'Search the ledger too (removed items)', lt: 'Ieškoti ir žurnale (pašalintos prekės)' },
  warehouse: { en: 'Warehouse', lt: 'Sandėlis' },
  bol_received: { en: 'BOL received', lt: 'BOL gauta' },
  ledger_matches: { en: 'Ledger memory', lt: 'Žurnalo atmintis' },
  candidates: { en: 'Candidates', lt: 'Kandidatai' },
  trail: { en: 'Trail', lt: 'Kelias' },
  open_trail: { en: 'Open trail', lt: 'Atverti kelią' },
  trail_empty_title: { en: 'No item selected', lt: 'Prekė nepasirinkta' },
  trail_empty_text: { en: 'Scan a barcode or pick a result to see where the item has been.', lt: 'Nuskenuokite kodą arba pasirinkite rezultatą, kad pamatytumėte, kur prekė buvo.' },
  right_now: { en: 'Right now', lt: 'Dabar' },
  not_on_shelf: { en: 'Not on any shelf', lt: 'Nėra nė vienoje lentynoje' },
  last_left: { en: 'Last left', lt: 'Paskutinį kartą paliko' },
  last_seen_at: { en: 'Last seen at', lt: 'Paskutinį kartą matyta' },
  clues: { en: 'Clues', lt: 'Užuominos' },
  no_clues: { en: 'Nothing unusual found.', lt: 'Nieko neįprasto nerasta.' },
  timeline: { en: 'Timeline', lt: 'Laiko juosta' },
  all_records: { en: 'All records', lt: 'Visi įrašai' },
  hide_undone: { en: 'Hide undone', lt: 'Slėpti atšauktus' },
  details: { en: 'Details', lt: 'Detalės' },
  received: { en: 'Received', lt: 'Gauta' },
  shelf_adds: { en: 'Shelf adds', lt: 'Padėta į lentyną' },
  pulled: { en: 'Pulled', lt: 'Paimta' },
  sold: { en: 'Sold', lt: 'Parduota' },
  ...
  focus_clear: { en: 'Show all events', lt: 'Rodyti visus įvykius' },
  events: { en: 'events', lt: 'įvykiai' },
  no_events: { en: 'No events recorded for this item.', lt: 'Šiai prekei įvykių neužfiksuota.' },
  loading_trail: { en: 'Loading trail…', lt: 'Kraunamas kelias…' },
  trail_failed: { en: 'Could not load the trail.', lt: 'Nepavyko įkelti kelio.' },
  open_in_warehouse: { en: 'Open in Warehouse', lt: 'Atverti sandėlyje' },
  previously_matched_as: { en: 'Previously matched as', lt: 'Anksčiau sutapatinta kaip' },
  forget: { en: 'Forget', lt: 'Pamiršti' },
  warehouse_note: { en: 'Warehouse note', lt: 'Sandėlio pastaba' },
  item_prep: { en: 'Item prep', lt: 'Prekės paruošimas' },
  seen_in_ledger: { en: 'seen in ledger', lt: 'matyta žurnale' },
  today: { en: 'Today', lt: 'Šiandien' },
  yesterday: { en: 'Yesterday', lt: 'Vakar' },
  search_result_hint: { en: 'Click a result to open its trail', lt: 'Spustelėkite rezultatą, kad atvertumėte jo kelią' },
